...
import { Pokemon, PokemonData, EvolutionChainNode, Species } from '../interfaces/pokemon.interface';
  ...
  template: `
    ...
    <main id="pokemons">
      <div id="pokemon">
        ...
        <img
          src="{{ this.pokemon?.gifImg }}"
          alt="{{ this.pokemon?.gifImg }}"
        />
        ...
        @for (pokemon of this.pokemon?.evolutions; track $index) {
        <div>
          <img src="{{ pokemon.img }}" alt="" />
          <img src="{{ pokemon.gifImg }}" alt="" />
          <p>{{ pokemon.index }}</p>
          <p>{{ pokemon.name }}</p>
...
export class PokeCardComponent implements OnInit {
    ...
    this.pokeApi
      ...
      .subscribe({
        next: ({ pokemonData, evolutionChain, species }) => {
          this.pokeInterface(pokemonData, evolutionChain, species);
  ...
  pokeInterface(
    ...
    this.pokemon = {
      ...
      gifImg: pokemonData.sprites.other.showdown.front_default,
      ...
      genetik: species.genera[7].genus,
    } as Pokemon;
  }
